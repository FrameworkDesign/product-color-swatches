...
namespace Weareframework\ProductColorSwatches\Library\Files;
...
class File
{
    ...
    public function __construct(Config $config, Manager $manager, Yaml $yaml, Sites $sites) {
        ...
        $this->yaml = $yaml;
        $this->configFile = $config->get('statamic.product-color-swatches.file');
    ...
    private function file() {
        return base_path("content/product-color-swatches-settings/{$this->configFile}_{$this->locale}.yaml");
    }
    ...
    private function cacheKey() {
        return "product_color_swatches_settings_{$this->locale}";
    }
}
